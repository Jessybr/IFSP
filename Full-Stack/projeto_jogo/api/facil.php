...
if (isset($_SESSION['n_jogadas']) && $_SESSION['n_jogadas'] == 2 && !isset($_POST['acao'])) {
    if (isset($_GET['l']) && isset($_GET['c']) && isset($_SESSION['l_antigo']) && isset($_SESSION['c_antigo']) &&  $_SESSION['facil'][$_GET['l']][$_GET['c']] == $_SESSION['facil'][$_SESSION['l_antigo']][$_SESSION['c_antigo']]) {
        $_SESSION['final_tab'][$_GET['l']][$_GET['c']] = true;
        $_SESSION['final_tab'][$_SESSION['l_antigo']][$_SESSION['c_antigo']] = true;
        $_SESSION['pontos'] += 5;
    }elseif(isset($_SESSION['pontos'])){
        $_SESSION['pontos'] -= 2;
    }
}
                        ...
                        <?php for ($c = 0; $c < 4; $c++) {    ?>
                            ...
                            <?php if (isset($_GET["l"]) && isset($_GET["c"]) && $_GET['l'] == $l && $_GET['c'] == $c) { ?>
                                <td>
                                    ...
                                    <div class="cartas">
                                    <a href="?l=<?= $l ?>&c=<?= $c ?>">
                                        <img src="imag/<?= $_SESSION['facil'][$l][$c] ?>.jpg">
                                    </a>
                                    </div>
                                </td>
                            ...
                            <?php } else if (
                                ...
                                <div class="cartas">
                                    <a href="?l=<?= $_SESSION['l_antigo'] ?>&c=<?= $_SESSION['c_antigo'] ?>">
                                        <img src="imag/<?= $_SESSION['facil'][$_SESSION['l_antigo']][$_SESSION['c_antigo']] ?>.jpg">
                                    </a>
                                    </div>
                                </td>
                            <?php }
